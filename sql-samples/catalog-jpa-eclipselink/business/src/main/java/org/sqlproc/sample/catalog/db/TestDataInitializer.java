...
public class TestDataInitializer implements InitializingBean, ApplicationContextAware {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        if (initData) {
            ...
            this.loadImages(item, loader);
            this.itemService.create(item);
            item = new Item(10, "feline02", "Alley Cat",
            ...
            this.loadImages(item, loader);
            this.itemService.create(item);
            item = new Item(17, "feline02", "Super Lazy cat",
            ...
            this.loadImages(item, loader);
            this.itemService.create(item);
            item = new Item(28, "feline02", "Young Saber Cat", "Buy me", "images/cat11.gif", "images/cat11.gif", 237);
            this.loadImages(item, loader);
            this.itemService.create(item);
