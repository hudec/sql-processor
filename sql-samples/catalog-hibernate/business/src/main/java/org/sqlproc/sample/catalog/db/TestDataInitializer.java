    ...
    public void afterPropertiesSet() throws Exception {
        ...
        if (initData) {
            ...
            try {
                ...
                Item item;
                // fill with test data
                item = newItem(1, "feline01", "Friendly Cat",
                ...
                item = newItem(2, "feline01", "Fluffy Cat",
                ...
                loadImages(item, loader);
                itemService.create(item);
                item = newItem(3, "feline02", "Sneaky Cat",
                ...
                loadImages(item, loader);
                itemService.create(item);
                item = newItem(4, "feline02", "Lazy Cat",
                ...
                loadImages(item, loader);
                itemService.create(item);
                item = newItem(5, "feline01", "Old Cat",
                ...
                loadImages(item, loader);
                itemService.create(item);
                item = newItem(6, "feline02", "Young Female cat",
                ...
                loadImages(item, loader);
                itemService.create(item);
                item = newItem(7, "feline01", "Playful Female Cat",
                ...
                loadImages(item, loader);
                itemService.create(item);
                item = newItem(8, "feline01", "White Fluffy Cat",
                ...
                loadImages(item, loader);
                itemService.create(item);
                item = newItem(9, "feline02", "Tiger Stripe Cat",
                ...
                loadImages(item, loader);
                itemService.create(item);
                item = newItem(10, "feline02", "Alley Cat",
                ...
                loadImages(item, loader);
                itemService.create(item);
                item = newItem(11, "feline02", "Speedy Cat",
                ...
                loadImages(item, loader);
                itemService.create(item);
                item = newItem(12, "feline01", "Stylish Cat",
                ...
                loadImages(item, loader);
                itemService.create(item);
                item = newItem(13, "feline01", "Smelly Cat",
                ...
                loadImages(item, loader);
                itemService.create(item);
                item = newItem(14, "feline01", "Saber Cat",
                ...
                loadImages(item, loader);
                itemService.create(item);
                item = newItem(15, "feline01", "Sophisticated Cat",
                ...
                loadImages(item, loader);
                itemService.create(item);
                item = newItem(17, "feline02", "Super Lazy cat",
                ...
                loadImages(item, loader);
                itemService.create(item);
                item = newItem(18, "feline02", "Scapper male cat",
                ...
                loadImages(item, loader);
                itemService.create(item);
                item = newItem(20, "feline01", "Older Cat",
                        "A great old pet retired from duty in the circus. This fully-trained tiger is looking for a place to retire. Loves to roam free and loves to eat other animals.",
                ...
                loadImages(item, loader);
                itemService.create(item);
                item = newItem(23, "feline01", "Sweety Alley Cat",
                ...
                loadImages(item, loader);
                itemService.create(item);
                item = newItem(28, "feline02", "Young Saber Cat", "Buy me", "images/cat11.gif", "images/cat11.gif",
                        237);
                loadImages(item, loader);
                itemService.create(item);
