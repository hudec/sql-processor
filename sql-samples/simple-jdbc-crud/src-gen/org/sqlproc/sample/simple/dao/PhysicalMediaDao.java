...
public class PhysicalMediaDao {
  ...
  public PhysicalMediaDao(final SqlEngineFactory sqlEngineFactory) {
    this.sqlEngineFactory = sqlEngineFactory;
  }
  
  public PhysicalMediaDao(final SqlEngineFactory sqlEngineFactory, final SqlSessionFactory sqlSessionFactory) {
    this.sqlEngineFactory = sqlEngineFactory;
  ...
  public SqlControl getMoreResultClasses(final PhysicalMedia physicalMedia, SqlControl sqlControl) {
    ...
    if (physicalMedia != null && physicalMedia.toInit_(PhysicalMedia.Association.media.name())) {
