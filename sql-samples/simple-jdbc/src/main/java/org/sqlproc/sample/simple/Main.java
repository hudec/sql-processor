...
public class Main {
    ...
    public List<Person> listLike(SqlSession session, Person person) {
        ...
        List<Person> list = sqlEngine.query(session, Person.class, person, OrderIds.NAME);
        logger.info("listSome size: " + list.size());
        return list;
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        Person honza = main.insert(session, new Person("Honza"), new Contact("Honza address 1"),
                new Contact("Honza address 2"));
        Person honzik = main.insert(session, new Person("Honzik"));
        Person andrej = main.insert(session, new Person("Andrej"), new Contact("Andrej address 1"));
        ...
        Subscriber arnost = main.insertSubscriber(session, new Subscriber("Arnost", lib));
        Subscriber maria = main.insertSubscriber(session, new Subscriber("Maria", lib));
        ...
        // custom type
        Person pepa = main.insertCustom(session, new Person("Pepa"),
