...
class SqlInputValue {
    ...
    SqlInputValue(SqlProcessContext ctx, String name, SqlInputValue sqlInputValue, Object dynamicInputValues) {
        ...
        if (sqlInputValue.fullInputName != null || sqlInputValue.inputName != null) {
            ...
            for (int i = 0; i < ss.length; i++) {
                Object value = (i == 0) ? dynamicInputValues : this.inputValue;
                if (value == null)
     ...
     * 
     * @return the indicator the input value is bounded to the SET or VALUES fragment of META SQL
     */
    public Boolean getInSetOrInsert() {
        return inSetOrInsert;
    }
    ...
    public String toString() {
        ...
        sb.append(", inSetOrInsert=").append(inSetOrInsert);
