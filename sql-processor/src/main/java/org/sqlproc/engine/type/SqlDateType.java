 ...
 */
public abstract class SqlDateType extends SqlProviderType {
    ...
    public void setResult(SqlRuntimeContext runtimeCtx, Object resultInstance, String attributeName,
        ...
        if (BeanUtils.simpleSetAttribute(runtimeCtx, resultInstance, attributeName, resultValue, java.sql.Date.class,
