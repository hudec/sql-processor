...
public class TestUndefinedParameters extends TestDatabase {
    ...
    @Test
    public void testUndefinedJava8DateParameters() throws SQLException, ParseException {
        SqlQueryEngine sqlEngine = getSqlEngine("UNDEFINED_JAVA8_DATE_PARAMETERS");
    ...
    @Test
    public void testUndefinedJava8InstantParameters() throws SQLException, ParseException {
