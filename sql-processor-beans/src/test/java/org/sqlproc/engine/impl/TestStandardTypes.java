...
public class TestStandardTypes extends TestDatabase {
    ...
    @Test
    public void testJava8DateStandardTypes() {
        SqlQueryEngine sqlEngine = getSqlEngine("STANDARD_JAVA8_DATE_TYPES");
    ...
    @Test
    public void testJava8InstantStandardTypes() {
        SqlQueryEngine sqlEngine = getSqlEngine("STANDARD_JAVA8_INSTANT_TYPES");
