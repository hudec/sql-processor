...
public class TestHibernateTypes extends TestDatabase {
    ...
    @Test
    public void testHibernateTypes() throws SQLException {
        SqlQueryEngine sqlEngine = getSqlEngine("HIBERNATE_TYPES");
    ...
    @Test
    public void testHibernateTypes2() throws SQLException {
        SqlQueryEngine sqlEngine = getSqlEngine("HIBERNATE_TYPES_2");
