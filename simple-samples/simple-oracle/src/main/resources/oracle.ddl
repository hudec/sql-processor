...
CREATE OR REPLACE PROCEDURE new_person (newid OUT NUMBER(19), date_of_birth IN DATE, ssn IN VARCHAR2, first_name IN VARCHAR2, last_name IN VARCHAR2, gender IN VARCHAR2)
IS
BEGIN
--   DECLARE
   BEGIN
