...
DROP TABLE TYPES_EXT IF EXISTS CASCADE;
...
ALTER TABLE PERSON_DETAIL ADD CONSTRAINT PK_PERSON_DETAIL
	PRIMARY KEY (ID, TYPE)
;
...
CREATE PROCEDURE NEW_PERSON(OUT newid BIGINT, IN date_of_birth DATE, IN ssn VARCHAR(20), IN first_name VARCHAR(100), IN last_name VARCHAR(100), IN gender VARCHAR(1))
  MODIFIES SQL DATA
  BEGIN ATOMIC
