...
public class ContactDao {
    ...
    public int update(final SqlSession sqlSession, final Contact contact, SqlControl sqlControl) {
        ...
        org.sqlproc.engine.SqlCrudEngine sqlUpdateEngineContact = sqlEngineFactory
                .getCheckedCrudEngine("UPDATE_CONTACT");
    ...
    public int delete(final SqlSession sqlSession, final Contact contact, SqlControl sqlControl) {
        ...
        org.sqlproc.engine.SqlCrudEngine sqlDeleteEngineContact = sqlEngineFactory
                .getCheckedCrudEngine("DELETE_CONTACT");
    ...
    public int query(final SqlSession sqlSession, final Contact contact, SqlControl sqlControl,
            final SqlRowProcessor<Contact> sqlRowProcessor) {
        if (logger.isTraceEnabled()) {
    ...
    public int query(final SqlSession sqlSession, final Contact contact,
            final SqlRowProcessor<Contact> sqlRowProcessor) {
    ...
    public List<Contact> listFromTo(final SqlSession sqlSession, final Contact contact, SqlControl sqlControl) {
        ...
        final java.util.List<java.lang.Long> ids_ = sqlEngineContact.query(sqlSession, java.lang.Long.class, contact,
                sqlControl);
