...
public class Person implements Serializable {
    ...
    public String toStringFull() {
        return "Person [id=" + id + ", firstName=" + firstName + ", lastName=" + lastName + ", dateOfBirth="
                + dateOfBirth + ", gender=" + gender + ", ssn=" + ssn + ", personDetail=" + personDetail
                + ", contacts=" + contacts + ", onlyIds=" + onlyIds + ", ids=" + ids + "]";
    }
    ...
    public void setInitAssociations(Set<String> initAssociations) {
