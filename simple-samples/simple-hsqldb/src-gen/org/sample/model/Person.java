...
public class Person implements Serializable {
    ...
    public Person _setDateOfBirth(final LocalDate dateOfBirth) {
        this.dateOfBirth = dateOfBirth;
        return this;
    }
    ...
    public Person _setOnlyIds_(final boolean onlyIds_) {
        this.onlyIds_ = onlyIds_;
        return this;
    }
    ...
    public Person _setIds_(final List<Long> ids_) {
        this.ids_ = ids_;
        return this;
    }
    ...
    public String toString() {
        return "Person [id=" + id + ", firstName=" + firstName + ", lastName=" + lastName + ", dateOfBirth="
                + dateOfBirth + ", gender=" + gender + ", ssn=" + ssn + "]";
    }

    public String toStringFull() {
        return "Person [id=" + id + ", firstName=" + firstName + ", lastName=" + lastName + ", dateOfBirth="
                + dateOfBirth + ", gender=" + gender + ", ssn=" + ssn + ", contacts=" + contacts + ", personDetails="
                + personDetails + ", onlyIds_=" + onlyIds_ + ", ids_=" + ids_ + "]";
    }
