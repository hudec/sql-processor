...
public class PersonDetail implements Serializable {
    ...
    public String toString() {
        return "PersonDetail [type=" + type + ", weight=" + weight + ", height=" + height + ", disposition="
                + disposition + ", titles=" + titles + "]";
    }

    public String toStringFull() {
        return "PersonDetail [id=" + id + ", type=" + type + ", weight=" + weight + ", height=" + height
                + ", disposition=" + disposition + ", titles=" + titles + ", onlyIds=" + onlyIds + ", ids=" + ids + "]";
    }
