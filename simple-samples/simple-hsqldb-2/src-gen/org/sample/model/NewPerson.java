...
public class NewPerson implements Serializable {
	...
	public static final int ORDER_BY_NEWID = 0;
	public static final int ORDER_BY_DATE_OF_BIRTH = 0;
	public static final int ORDER_BY_SSN = 0;
	public static final int ORDER_BY_FIRST_NAME = 0;
	public static final int ORDER_BY_LAST_NAME = 0;
	public static final int ORDER_BY_GENDER = 0;
