		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getPojogenPropertyAccess().getGroup_19_5(), "rule__PojogenProperty__Group_19_5__0");
					...
					put(grammarAccess.getPojogenPropertyAccess().getJoinTablesAssignment_6_1_1(), "rule__PojogenProperty__JoinTablesAssignment_6_1_1");
					...
					put(grammarAccess.getPojogenPropertyAccess().getColumnTypesAssignment_10_3_1(), "rule__PojogenProperty__ColumnTypesAssignment_10_3_1");
					put(grammarAccess.getPojogenPropertyAccess().getNameAssignment_11_0(), "rule__PojogenProperty__NameAssignment_11_0");
					put(grammarAccess.getPojogenPropertyAccess().getTablesAssignment_11_1_1(), "rule__PojogenProperty__TablesAssignment_11_1_1");
					...
					put(grammarAccess.getPojogenPropertyAccess().getColumnsAssignment_12_3_1(), "rule__PojogenProperty__ColumnsAssignment_12_3_1");
					...
					put(grammarAccess.getPojogenPropertyAccess().getExportsAssignment_13_3_1(), "rule__PojogenProperty__ExportsAssignment_13_3_1");
					...
					put(grammarAccess.getPojogenPropertyAccess().getImportsAssignment_17_3_1(), "rule__PojogenProperty__ImportsAssignment_17_3_1");
					...
					put(grammarAccess.getPojogenPropertyAccess().getMany2sAssignment_18_3_1(), "rule__PojogenProperty__Many2sAssignment_18_3_1");
					...
					put(grammarAccess.getPojogenPropertyAccess().getDbColumnAssignment_19_4(), "rule__PojogenProperty__DbColumnAssignment_19_4");
					put(grammarAccess.getPojogenPropertyAccess().getInheritanceAssignment_19_5_1(), "rule__PojogenProperty__InheritanceAssignment_19_5_1");
					put(grammarAccess.getPojogenPropertyAccess().getNameAssignment_20_0(), "rule__PojogenProperty__NameAssignment_20_0");
					put(grammarAccess.getPojogenPropertyAccess().getMethodsAssignment_20_1_1(), "rule__PojogenProperty__MethodsAssignment_20_1_1");
					put(grammarAccess.getPojogenPropertyAccess().getNameAssignment_21_0(), "rule__PojogenProperty__NameAssignment_21_0");
					put(grammarAccess.getPojogenPropertyAccess().getToImplementsAssignment_21_1_1(), "rule__PojogenProperty__ToImplementsAssignment_21_1_1");
					put(grammarAccess.getPojogenPropertyAccess().getNameAssignment_22_0(), "rule__PojogenProperty__NameAssignment_22_0");
					put(grammarAccess.getPojogenPropertyAccess().getToExtendsAssignment_22_2(), "rule__PojogenProperty__ToExtendsAssignment_22_2");
					put(grammarAccess.getPojogenPropertyAccess().getNameAssignment_23(), "rule__PojogenProperty__NameAssignment_23");
