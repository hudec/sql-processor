		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getPropertyAccess().getTypeAssignment_0_7_2(), "rule__Property__TypeAssignment_0_7_2");
					put(grammarAccess.getPropertyAccess().getTypeNameAssignment_0_7_4(), "rule__Property__TypeNameAssignment_0_7_4");
					...
					put(grammarAccess.getPropertyAccess().getTypeAssignment_0_8_4(), "rule__Property__TypeAssignment_0_8_4");
					put(grammarAccess.getPropertyAccess().getTypeNameAssignment_0_8_6(), "rule__Property__TypeNameAssignment_0_8_6");
