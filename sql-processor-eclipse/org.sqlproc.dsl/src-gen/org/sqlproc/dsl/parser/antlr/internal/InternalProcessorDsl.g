...
(
    ...
    |((
(
		lv_name_27_0=	'of-type' 
    {
        newLeafNode(lv_name_27_0, grammarAccess.getDatabasePropertyAccess().getNameOfTypeKeyword_11_0_0());
    }
 
	    {
	        if ($current==null) {
       		...
       		setWithLastConsumed($current, "name", lv_name_27_0, "of-type");
	    }
