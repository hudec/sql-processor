 ...
 *   <li>{@link org.sqlproc.dsl.processorDsl.impl.MappingColumnImpl#getVals <em>Vals</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MappingColumnImpl extends MinimalEObjectImpl.Container implements MappingColumn
{
  ...
  public EList<String> getVals()
  {
    if (vals == null)
    {
      vals = new EDataTypeEList<String>(String.class, this, ProcessorDslPackage.MAPPING_COLUMN__VALS);
    }
    return vals;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ProcessorDslPackage.MAPPING_COLUMN__NAME:
        return getName();
      case ProcessorDslPackage.MAPPING_COLUMN__VALS:
        return getVals();
    }
