...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Column Usage</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.sqlproc.dsl.processorDsl.impl.ColumnUsageImpl#getStatement <em>Statement</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ColumnUsageImpl extends PojoUsageImpl implements ColumnUsage
{
  /**
  ...
  {
    return ProcessorDslPackage.Literals.COLUMN_USAGE;
  }
    ...
    if (statement != null && statement.eIsProxy())
    {
      ...
      if (statement != oldStatement)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ProcessorDslPackage.COLUMN_USAGE__STATEMENT, oldStatement, statement));
      }
    }
    return statement;
  }
  ...
  public void setStatement(MetaStatement newStatement)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorDslPackage.COLUMN_USAGE__STATEMENT, oldStatement, statement));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ProcessorDslPackage.COLUMN_USAGE__STATEMENT:
