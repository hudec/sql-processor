...
public class ProcessorDslSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_DatabaseProperty_WSTerminalRuleCall_11_1_p;
	...
	protected void init(IGrammarAccess access) {
		...
		match_DatabaseProperty_WSTerminalRuleCall_11_1_p = new TokenAlias(true, false, grammarAccess.getDatabasePropertyAccess().getWSTerminalRuleCall_11_1());
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			else if(match_DatabaseProperty_WSTerminalRuleCall_11_1_p.equals(syntax))
				emit_DatabaseProperty_WSTerminalRuleCall_11_1_p(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *     WS+
	 */
	protected void emit_DatabaseProperty_WSTerminalRuleCall_11_1_p(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
