...
public class AbstractProcessorDslSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_Artifact_WSTerminalRuleCall_0_p;
	protected AbstractElementAlias match_Artifact_WSTerminalRuleCall_1_0_1_p;
	protected AbstractElementAlias match_Artifact_WSTerminalRuleCall_1_2_1_p;
	...
	protected AbstractElementAlias match_IfSqlCond_WSTerminalRuleCall_2_p;
	protected AbstractElementAlias match_IfSqlCond_WSTerminalRuleCall_3_3_a;
	protected AbstractElementAlias match_IfSqlCond_WSTerminalRuleCall_3_3_p;
	...
	protected void init(IGrammarAccess access) {
		...
		match_Artifact_WSTerminalRuleCall_0_p = new TokenAlias(false, true, grammarAccess.getArtifactAccess().getWSTerminalRuleCall_0());
		match_Artifact_WSTerminalRuleCall_1_0_1_p = new TokenAlias(false, true, grammarAccess.getArtifactAccess().getWSTerminalRuleCall_1_0_1());
		match_Artifact_WSTerminalRuleCall_1_2_1_p = new TokenAlias(false, true, grammarAccess.getArtifactAccess().getWSTerminalRuleCall_1_2_1());
		...
		match_IfSqlCond_WSTerminalRuleCall_2_p = new TokenAlias(false, true, grammarAccess.getIfSqlCondAccess().getWSTerminalRuleCall_2());
		...
		match_IfSqlCond_WSTerminalRuleCall_3_3_p = new TokenAlias(false, true, grammarAccess.getIfSqlCondAccess().getWSTerminalRuleCall_3_3());
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		if (!transition.isSyntacticallyAmbiguous())
			return;
		if(match_Artifact_WSTerminalRuleCall_0_p.equals(transition.getAmbiguousSyntax()))
			emit_Artifact_WSTerminalRuleCall_0_p(semanticObject, transition, fromNode, toNode);
		else if(match_Artifact_WSTerminalRuleCall_1_0_1_p.equals(transition.getAmbiguousSyntax()))
			emit_Artifact_WSTerminalRuleCall_1_0_1_p(semanticObject, transition, fromNode, toNode);
		else if(match_Artifact_WSTerminalRuleCall_1_2_1_p.equals(transition.getAmbiguousSyntax()))
			emit_Artifact_WSTerminalRuleCall_1_2_1_p(semanticObject, transition, fromNode, toNode);
		...
		else if(match_IfSqlCond_WSTerminalRuleCall_2_p.equals(transition.getAmbiguousSyntax()))
			emit_IfSqlCond_WSTerminalRuleCall_2_p(semanticObject, transition, fromNode, toNode);
		...
		else if(match_IfSqlCond_WSTerminalRuleCall_3_3_p.equals(transition.getAmbiguousSyntax()))
			emit_IfSqlCond_WSTerminalRuleCall_3_3_p(semanticObject, transition, fromNode, toNode);
			...
			emit_Mapping_WSTerminalRuleCall_3_p(semanticObject, transition, fromNode, toNode);
	 ...
	 *     WS+
	 */
	protected void emit_Artifact_WSTerminalRuleCall_0_p(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
	 ...
	 *     WS+
	 */
	protected void emit_Artifact_WSTerminalRuleCall_1_0_1_p(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		acceptNodes(transition, fromNode, toNode);
	}
	 ...
	 *     WS+
	 */
	protected void emit_Artifact_WSTerminalRuleCall_1_2_1_p(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		acceptNodes(transition, fromNode, toNode);
	}
	 ...
	 *     WS+
	 */
	protected void emit_IfSqlCond_WSTerminalRuleCall_2_p(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		acceptNodes(transition, fromNode, toNode);
	}
	 ...
	 *     WS+
	 */
	protected void emit_IfSqlCond_WSTerminalRuleCall_3_3_p(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		acceptNodes(transition, fromNode, toNode);
	}
	 ...
	 *     WS+
	 */
	protected void emit_Mapping_WSTerminalRuleCall_3_p(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		acceptNodes(transition, fromNode, toNode);
	}
