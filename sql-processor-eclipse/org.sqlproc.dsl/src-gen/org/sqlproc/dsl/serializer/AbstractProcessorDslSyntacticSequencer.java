...
public class AbstractProcessorDslSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_Artifact_WSTerminalRuleCall_1_1_1_p;
	...
	protected void init(IGrammarAccess access) {
		...
		match_Artifact_WSTerminalRuleCall_1_1_1_p = new TokenAlias(false, true, grammarAccess.getArtifactAccess().getWSTerminalRuleCall_1_1_1());
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		else if(match_Artifact_WSTerminalRuleCall_1_1_1_p.equals(transition.getAmbiguousSyntax()))
			emit_Artifact_WSTerminalRuleCall_1_1_1_p(semanticObject, transition, fromNode, toNode);
	 ...
	 *     WS+
	 */
	protected void emit_Artifact_WSTerminalRuleCall_1_1_1_p(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		acceptNodes(transition, fromNode, toNode);
	}
	 ...
	 *     WS+
	 */
	protected void emit_IfSqlCond_WSTerminalRuleCall_3_1_p(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		acceptNodes(transition, fromNode, toNode);
	}
